    ...
    rsx! {
        div { class: "max-w-6xl mx-auto p-6 space-y-6",
            ...
            div { class: "grid grid-cols-1 lg:grid-cols-3 gap-6",
                ...
                div { class: "lg:col-span-2 space-y-6",
                    ...
                    div { class: "bg-white rounded-lg shadow-md p-6 border border-gray-200",
                        h2 { class: "text-2xl font-semibold mb-2", "Quick Start" }
                    ...
                    div { class: "bg-white rounded-lg shadow-md p-6 border border-gray-200",
                        h2 { class: "text-2xl font-semibold mb-2", "Inputs & Field Guide" }
                        p { class: "text-gray-800 mb-2", "What to enter in each field:" }
                        dl {
                            div { class: "mb-2",
                                dt { class: "font-medium", "Description" }
                                dd { class: "text-gray-800",
                                    "A short label for the income or debt (e.g., 'Salary', 'Car loan')."
                                }
                            }
                            div { class: "mb-2",
                                dt { class: "font-medium", "Type" }
                                dd { class: "text-gray-800",
                                    "Optional class (W2, 1099, Auto, Student, etc.)."
                                }
                            }
                            div { class: "mb-2",
                                dt { class: "font-medium", "Monthly Amount" }
                                dd { class: "text-gray-800",
                                    "Enter the recurring monthly value. Use numbers only (decimals allowed)."
                                }
                            }
                            div { class: "mb-2",
                                dt { class: "font-medium", "Housing fields" }
                                dd { class: "text-gray-800",
                    ...
                    // Examples
                    div { class: "bg-white rounded-lg shadow-md p-6 border border-gray-200",
                        h2 { class: "text-2xl font-semibold mb-2", "Examples" }
                        p { class: "text-gray-800 mb-2", "Example (consumer):" }
                        pre { class: "bg-gray-50 p-3 rounded text-sm text-gray-800",
                ...
                div { class: "space-y-6",
                    ...
                    // Troubleshooting
                    div { class: "bg-white rounded-lg shadow-md p-6 border border-gray-200",
                        h3 { class: "text-xl font-semibold mb-2", "Troubleshooting" }
                        ul {
                            li { class: "mb-2",
                    ...
                    // Contact / feedback
                    div { class: "bg-white rounded-lg shadow-md p-6 border border-gray-200",
                        h3 { class: "text-xl font-semibold mb-2", "Contact & Feedback" }
            ...
            div { class: "bg-white rounded-lg shadow-md p-4 border border-gray-200 flex flex-col md:flex-row md:justify-between items-start md:items-center",
                ...
                p { class: "text-sm text-gray-800 mt-3 md:mt-0", "Version: dev" }
            }
        }
    }
}
